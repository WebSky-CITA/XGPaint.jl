...
function write_chunk(
    ...
    @time sourcesCIB = generate_sources(modelCIB, cosmo, pos, mass);
...
##
function run_all_chunks(output_dir, halo_pos, halo_mass, freqs; N_chunks=8)
...
scratch_dir = "/home/dongwooc/projectscratchspace/cib_co_scarfy_20260622/"
