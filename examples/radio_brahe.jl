...
halo_pos, halo_mass = read_halo_catalog_hdf5("/media/science/xgpaint_data/websky_halos-light.hdf5")
...
for freq in [
    ...
    @time begin
        flux_I, flux_II, redshift_I, redshift_II = paint!(m, parse(Float32, freq) * 1.0f9, radio_model, sources, return_fluxes = true)
